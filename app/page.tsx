            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative aspect-video rounded-lg overflow-hidden shadow-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      <h3 className="text-xl font-bold mb-2">Visualize in Your Space</h3>
                      <p>See exactly how our lighting products will look in your home</p>
                    </div>
                  </div>
                </div>
              </div>
              <div>
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl font-bold">The Future of Shopping is Here</h2>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>Works on most modern smartphones</span>
                    </li>
                    <li className="flex items-start">
                      <div className="mr-2 mt-1 bg-green-100 p-1 rounded-full">
                        <svg className="h-3 w-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <span>Accurate size and appearance</span>
                    </li>
                  </ul>
                  <Button
                    asChild
